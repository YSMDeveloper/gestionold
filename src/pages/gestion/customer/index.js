    ...
    return (
        <Layout nodeRef={nodeRef}>
                ...
                <Table celled>
                    ...
                    <Table.Body >
                        {customers && customers.map((customer) => <Customer key={customer._id} customer={customer} showAs="Default"/>)}
                    </Table.Body>
                    <Table.Footer>
                        <Table.Row>
                            <Table.HeaderCell colSpan='6' pageSize="10">
                                <Button
                                    floated='left'
                                    icon
                                    labelPosition='left'
                                ...
                                >
                                    <Icon name='user' /> Agregar cliente
                                </Button>
